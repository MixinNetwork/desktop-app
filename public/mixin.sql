...
CREATE VIRTUAL TABLE IF NOT EXISTS `messages_fts` USING FTS4(message_id UNINDEXED, conversation_id UNINDEXED, content, created_at UNINDEXED, message_index UNINDEXED, tokenize='unicode61');
