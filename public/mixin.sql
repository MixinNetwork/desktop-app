...
CREATE VIRTUAL TABLE IF NOT EXISTS `messages_fts` USING FTS4(message_id, conversation_id, content, created_at UNINDEXED, message_index UNINDEXED, tokenize='unicode61');
