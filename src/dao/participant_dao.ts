...
class ParticipantDao {
  ...
  findParticipantById(conversationId: any, userId: any) {
    return db.prepare('SELECT * FROM participants WHERE conversation_id = ? AND user_id = ?').get(conversationId, userId)
  }
}
