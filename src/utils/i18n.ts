...
let transactions = {
  en: {
    ...
    chat: {
      ...
      chat_not_support_url: 'https://mixinmessenger.zendesk.com/hc/articles/360043776071',
      chat_not_support: 'This type of message is not supported, please upgrade Mixin to the latest version. {0}',
      chat_unknown: '[Unknown type of Message. View on phone. ]',
      chat_decrypt_failed: 'Waiting for {0} to get online and establish an encrypted session. ',
      chat_decrypt_failed_info: 'Learn more.',
  ...
  zh: {
    ...
    chat: {
      ...
      chat_transfer: '[转账]',
      chat_not_support_url: 'https://mixinmessenger.zendesk.com/hc/articles/360043776071',
      chat_not_support: '不支持此类型消息。请升级 Mixin 查看。{0}',
